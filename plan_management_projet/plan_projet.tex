...
\newpage
    ...
    \begin{section}{\label{sec:Bilan de projet}Bilan de projet}
     ...
     \begin{subsection}{\label{sec:Production du bilan}}
         ...
         Ce dernier, ainsi que le documents évolutifs mis à jour relativement aux derniers événements du projet sont disponibles au travers d’une release sur l’outil de gestion de version qui trace les documents de gestion (voir la \hyperref[sec:Communication avec les parties prenantes]{communication avec les parties prenantes}).
     \end{subsection}
    \end{section}
}
