    ...
    \begin{subsection}{Sprint 0}
        \begin{table}[H]
            ...
            \begin{tabularx}{\columnwidth}{|X|X|}
                ...
                \hline
                Le prototypage d'IHM a été validé par le client dès le premier jet. & La configuration de l'environnement de travail sous Windows Subsystem for Linux (WSL) a posé quelques problèmes, notamment au niveau de la hot-reload de nodes.\\
                \hline
    ...
    \begin{subsection}{Sprint 3}
        \begin{table}[H]
            ...
            \begin{tabularx}{\columnwidth}{|X|X|}
                ...
                \cellcolor[HTML]{17FF00}Positif & \cellcolor[HTML]{FF2D00}Négatif\\
                \hline
                L'équipe à découvert une extension VSCode nommée Live Share qui permet de faire du peer-programming. Cela facilite le débogage. & L'équipe connaît une baisse de motivation qui la rend moins productive. \\
                \hline
